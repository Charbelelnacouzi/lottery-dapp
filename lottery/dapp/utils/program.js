...
export const getTotalPrize = (lottery) => {
  ...
  console.log("Total Prize in SOL (totalPrizeInLamports):", totalPrizeInLamports.toString());
  console.log("Total Prize in SOL (ticketPriceInLamports):", ticketPriceInLamports.toString());
